...
def make_dataset(dir,return_paths=False, max_dataset_size=float("inf")):
    images = []
...
class ImageFolder(data.Dataset):
    ...
    def __init__(self, root, transform=None, extend_paths=False,return_paths=False,
                 loader='RGB'):
        imgs = make_dataset(root,extend_paths)
        if len(imgs) == 0:
        ...
        self.extend_paths = extend_paths
